...
export const WhatsAppButton = () => {
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.95 }}
      className="fixed bottom-5 right-5 z-50 flex items-center justify-center w-14 h-14 rounded-full text-white shadow-lg hover:shadow-2xl transition-shadow duration-300"
